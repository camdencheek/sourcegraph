...
import { LoggersPanel } from './LoggersPanel'

export interface ExtensionsDevToolsProps
...
interface ExtensionDevelopmentToolsTab {
    ...
    label: string
    component: React.ComponentType<ExtensionsDevToolsProps>
}

const TABS: ExtensionDevelopmentToolsTab[] = [
    { id: 'activeExtensions', label: 'Active extensions', component: ActiveExtensionsPanel },
    { id: 'loggers', label: 'Loggers', component: LoggersPanel },
]

const ExtensionDevTools: React.FunctionComponent<ExtensionsDevToolsProps> = props => {
...
export const ExtensionDevToolsPopover = React.memo<ExtensionsDevToolsProps>(props => (
    <>
